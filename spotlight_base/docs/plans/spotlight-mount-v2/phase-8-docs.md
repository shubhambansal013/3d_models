# Phase 8: Docs — AGENTS.md, handoff golden numbers, PLAN/NOTES
...
## Responsibilities
Owns: `AGENTS.md`, `docs/plans/verification-handoff.md`,
`docs/plans/verification-test-plan.md`, and this plan's own PLAN/NOTES.
...
- [ ] Append the new kernel-measured golden numbers to
      `verification-handoff.md` (lip top z, roof bottom z, stop onset, catch
      onset, seat-clearance margin) and mark the old Ø150 table as superseded.
- [ ] Update `verification-test-plan.md` to the new geometry where it cites the
      old radii/volumes (sections 3.2–3.6), and mention the new `test_tilt.py`.
...
## Acceptance criteria
- AGENTS.md + both verification docs reflect the Ø100/Ø108 design with measured
  golden numbers; no stale Ø150/slice-artifact claims remain.
